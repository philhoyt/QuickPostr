 ...
 *
 * The uploaded attachment is tagged "pending" server-side; publishing a post
 * that uses it clears the tag, and abandoned shares are swept by a daily cron
 * job — so a shared-but-never-posted photo does not linger in the library.
 *
